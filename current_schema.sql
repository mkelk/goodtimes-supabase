...
ALTER TABLE ONLY "public"."albumimages"
    ADD CONSTRAINT "albumimages_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id");
...
ALTER TABLE ONLY "public"."helperroles"
    ADD CONSTRAINT "helperroles_helper_id_fkey" FOREIGN KEY ("helper_id") REFERENCES "public"."helpers"("id");



ALTER TABLE ONLY "public"."helpers"
    ADD CONSTRAINT "helpers_person_id_fkey" FOREIGN KEY ("person_id") REFERENCES "public"."persons"("id");



ALTER TABLE ONLY "public"."helpers"
    ADD CONSTRAINT "helpers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."imagegames"
    ADD CONSTRAINT "imagegames_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."persons"
    ADD CONSTRAINT "persons_opt_auth_id_fkey" FOREIGN KEY ("opt_auth_id") REFERENCES "auth"."users"("id");
